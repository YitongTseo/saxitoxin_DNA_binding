...
class StructureTraceback:
    ...
    @staticmethod
    def _sort_on_index(
        inlist: Union[list, None] = None,
        indexlist: Union[list, None] = None,
        index: bool = False,
    ) -> list:
        """
    ...
    def id_structures(self, filelist: Union[list, None] = None) -> None:
        ...
        if ext == "it0":
            ...
            print(
                "    * ERROR: Structure not present in either it0, it1 or water directory"
            )
            sys.exit(0)
    ...
    def setup_run_dir(self, paramdict: dict) -> None:
        ...
        if paramdict["inputdir"] and os.path.exists(paramdict["inputdir"]):
            if not os.path.exists(
                os.path.join(os.path.abspath(paramdict["inputdir"]), "begin")
            ):
    ...
    def get_it0_structures(self) -> None:
        ...
        if os.path.isfile("file.list"):
            ...
            print(
                "    * ERROR: No file.list found in it0 directory. Nothing to trace means stop"
            )
            sys.exit(0)
        ...
        self.complex_list = self.complex_list * int(
            (round(self.nrstrucit0 / nrstrucbg)) + 1
        )
    ...
    def get_it1_structures(self) -> None:
        ...
        if os.path.isfile("file.list"):
            ...
            print(
                "    * ERROR: No file.list found in it1 directory. Nothing to trace means stop"
            )
            sys.exit(0)
    ...
    def get_wat_structures(self) -> None:
        ...
        if self.nrstrucw > 0:
            ...
            print(
                "    No file.list of file.list_all found in water refinement directory. \
                    ...
                    if n == k[0]:
                        outfile.write(
                            "{:>35}{:10.0f}{:15.4f}{:10.0f}{:15.4f}{:10.0f}{:15.4f}\n".format(
                                ...
                                self.fileit0_list[self.fileit1_list.index(k)][1],
                                n,
                                k[1],
                    ...
                    if n == k[0]:
                        outfile.write(
                            "{:>35}{:10.0f}{:15.4f}{:10.0f}{:15.4f}{:10.0f}{:15.4f}\n".format(
                                ...
                                n,
                                k[1],
                                self.fileit1_list[self.fileit0_list.index(k)][0],
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        help="Supply pdb or file.nam inputfile(s). \
